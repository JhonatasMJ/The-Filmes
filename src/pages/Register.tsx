    ...
    <main className="lg:grid grid-cols-2 items-center">
      <section className="lg:max-w-7xl mx-auto py-10 w-11/12  lg:w-2/4 ">
        ...
        <p className="text-white mt-4">
          Para uma melhore experiência crie sua conta agora{" "}
        </p>
...
<div className="relative w-full">
  ...
  >
    { showPassword ? <IconEyeOff color="#ccc" /> : <IconEye  color="#ccc"/>}
        ...
        <p className="text-white text-center mt-6">Já tem uma conta? <span className="underline text-secondary font-semi-bold ml-2"><Link to="/">Fazer Login</Link></span></p>
      </section>
